...
export const informationData: Information = {
  ...
  icons: [
    { name: "Mail", icon: mailIcon, info: "hhnnttvy@example.com" },
    { name: "Phone", icon: phoneIcon, info: "+84 794 996 247" },
    { name: "GitHub", icon: githubIcon, info: "https://github.com/jjoevv" },
  ],
};
